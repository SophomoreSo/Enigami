...
and the assembly screen (UiKit's pixel look), and all text drawn in the world
(`PixelCamera.draw_text`). Its import is set to **no antialiasing, no hinting and no
