---
name: "source-command-tm-validate-dependencies"
description: "Migrated source command `tm-validate-dependencies`"
---

# source-command-tm-validate-dependencies

Use this skill when the user asks to run the migrated source command `tm-validate-dependencies`.
