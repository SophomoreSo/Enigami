---
name: "source-command-tm-remove-all-subtasks"
description: "Migrated source command `tm-remove-all-subtasks`"
---

# source-command-tm-remove-all-subtasks

Use this skill when the user asks to run the migrated source command `tm-remove-all-subtasks`.
