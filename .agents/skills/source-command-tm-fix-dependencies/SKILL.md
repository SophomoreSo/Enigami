---
name: "source-command-tm-fix-dependencies"
description: "Migrated source command `tm-fix-dependencies`"
---

# source-command-tm-fix-dependencies

Use this skill when the user asks to run the migrated source command `tm-fix-dependencies`.
