---
name: "source-command-tm-install-taskmaster"
description: "Migrated source command `tm-install-taskmaster`"
---

# source-command-tm-install-taskmaster

Use this skill when the user asks to run the migrated source command `tm-install-taskmaster`.
...
6. **Configure AI Provider**
   ...
   echo "- ANTHROPIC_API_KEY for Codex"
