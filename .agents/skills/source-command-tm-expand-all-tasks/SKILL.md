---
name: "source-command-tm-expand-all-tasks"
description: "Migrated source command `tm-expand-all-tasks`"
---

# source-command-tm-expand-all-tasks

Use this skill when the user asks to run the migrated source command `tm-expand-all-tasks`.
